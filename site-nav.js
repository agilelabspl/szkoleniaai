...
(function() {
    ...
    if (path.indexOf('/slownik/') !== -1 || path.indexOf('/wiedza-ai/') !== -1) {
        prefix = '../';
    }
    ...
    if (path === '/' || path.endsWith('/index.html') || path.endsWith('/szkoleniaai/')) {
        ...
        active = 'podcasty';
    } else if (path.indexOf('wiedza-ai') !== -1) {
        active = 'wiedza';
    ...
    html += '<nav class="site-nav">'
        ...
        + '<li><a href="' + prefix + 'podcasty-ai.html"' + (active === 'podcasty' ? ' class="active"' : '') + '>Podcasty AI</a></li>'
        + '<li><a href="' + prefix + 'wiedza-ai.html"' + (active === 'wiedza' ? ' class="active"' : '') + '>Wiedza o AI</a></li>'
